...
The release passed the complete offline Node.js and PowerShell suite, including provider routing, GLM preference, quota accounting, cooldowns, runtime circuits, credential redaction, Mission Control binding/redaction, Worker Protocol v2, worktree isolation, project-task retry/takeover behavior, proxy safety, and 19 deterministic Gate scenarios. `npm audit` reported zero known dependency vulnerabilities at release time.
